...
public class MsgStreamTest
{
    ...
    [TestMethod]
    public void ConstructorSuccessfullyCopiesMsgStream()
    {
        // Arrange
        ...
        // Act
        MsgStream copiedStream = new MsgStream(msgStream);
        
        // Assert
        Assert.AreEqual(msgStream.ReadMessage(0), copiedStream.ReadMessage(0));
    }
    ...
    [TestMethod]
    public void ReadMessageFailsIfIndexIsNegative()
    {
        // Arrange
        MsgStream testObject = new MsgStream(10);
    ...
    public void ResetStreamFailsIfStreamIsEmpty()
    {
        ...
        // Act & Assert
        Assert.ThrowsException<IndexOutOfRangeException>(() => testObject.Reset());
    }
    ...
    public void ResetStreamSuccessfullyResetsStream()
    {
        ...
        // Act
        bool testResult = testObject.Reset();
